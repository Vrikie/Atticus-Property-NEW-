...
function Paralaxtra(JSXElement, weight) {
  return class extends React.Component {
    ...
    componentDidMount() {
      ...
      const JSXElementWithRef = React.cloneElement(JSXElement, {
        ...JSXElement.props,
        ref: ref
      });
    ...
    animation_loop = () => {
      ...
      this.wrappedJSXElement.current.style.top = `${
        this.state.start_position - this.last_offset
      }px`;
    ...
    render() {
      return <Fragment>{this.state.WrappedJSXElement}</Fragment>;
    }
  };
}

export default Paralaxtra;
